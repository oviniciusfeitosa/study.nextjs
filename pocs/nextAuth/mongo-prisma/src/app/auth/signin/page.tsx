...
import { signInCredentialsAction } from "@/app/_actions/auth/credentials";
import { signInWithGoogle } from "@/app/_actions/auth/google";
...
const SignInPage = () => {
  ...
  const handleFormSubmit = async (formData: FormData) => {
    ...
    const res = await signInCredentialsAction({ email, password });
    if (res.error) {
      setError(res.error);
    }
  };
